    ...
    def password_validation(cls, password):
        if not validate_password(password):
            raise ValueError(
                ...
                "one digit, one special symbol, and have a minimum length of 8 characters")
        return password
...
class DisplayUser(BaseModel):
    ...
    @classmethod
    def from_query_result(cls, username: str, email: str, phone_number: str, first_name: str, last_name: str,
                          address: str):
        return cls(username=username, email=email, phone_number=phone_number, first_name=first_name,
...
class UpdateUser(BaseModel):
    ...
    @classmethod
    def from_query_result(cls, password: str, email: str, first_name: str, last_name: str, phone_number: str,
                          two_factor_method: str, title: str,
        ...
        return cls(old_password=password, email=email, phone_number=phone_number, first_name=first_name,
                   last_name=last_name, address=address, two_factor_method=two_factor_method, title=title,
                   gender=gender, photo_selfie=photo_selfie, identity_document=identity_document)
...
class AfterUpdateUser(BaseModel):
    ...
    @classmethod
    def from_query_result(cls, username, password: str, email: str, first_name: str, last_name: str, phone_number: str,
                          two_factor_method: str, title: str,
                          gender: str, photo_selfie: bytes, identity_document: bytes, address: str):
